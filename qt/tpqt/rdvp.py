...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_3.setGeometry(QtCore.QRect(30, 250, 91, 21))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(Dialog)
        self.label_4.setGeometry(QtCore.QRect(50, 310, 61, 20))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(Dialog)
        self.label_5.setGeometry(QtCore.QRect(20, 410, 101, 20))
        self.label_5.setObjectName("label_5")
        self.date = QtWidgets.QTextBrowser(Dialog)
        self.date.setGeometry(QtCore.QRect(130, 140, 256, 41))
        self.date.setObjectName("date")
        self.Lieu = QtWidgets.QTextBrowser(Dialog)
        self.Lieu.setGeometry(QtCore.QRect(130, 190, 256, 41))
        self.Lieu.setObjectName("Lieu")
        self.Description = QtWidgets.QTextBrowser(Dialog)
        self.Description.setGeometry(QtCore.QRect(130, 240, 256, 41))
        self.Description.setObjectName("Description")
        self.Duree = QtWidgets.QTextBrowser(Dialog)
        self.Duree.setGeometry(QtCore.QRect(130, 300, 256, 41))
        self.Duree.setObjectName("Duree")
        self.organisation = QtWidgets.QTextBrowser(Dialog)
        self.organisation.setGeometry(QtCore.QRect(130, 370, 256, 81))
